<x-app-layout>
    ...
    <div class="p-6">
        <form method="POST" action="{{ route('proveedores.store') }}" class="space-y-4">
            ...
            <div>
                <label>RUC</label>
                <input type="text" name="ruc" class="w-full border rounded p-2" required maxlength="11">
            </div>
            ...
            <div>
                ...
                <input type="text" name="contacto" class="w-full border rounded p-2">
            </div>
            ...
            <div>
                ...
                <input type="url" name="pagina_web" class="w-full border rounded p-2">
            </div>
